...
---
# <a name="set-up-and-use-microsoft-teams-with-remote-assist-to-collaborate-on-a-call"></a>Microsoft Teams mit Remote Assist zur telefonischen Zusammenarbeit einrichten und verwenden
...
Der [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Benutzer (Außendienstmitarbeiter) mit [!include[pn-HoloLens](../includes/pn-HoloLens.md)] benötigt:

-   [Ein Abonnement von Remote Assist.](../licensing/buy-and-deploy.md) Das [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Abonnement beinhaltet ein Abonnement von [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)].

-   Ein [!include[pn-hololens](../includes/pn-hololens.md)] mit dem [Update für Windows 10 vom April 2018](https://support.microsoft.com/en-us/help/12643) (oder höher).

-   Ein [!include[pn-azure-active-directory](../includes/pn-azure-active-directory.md)]-Konto.

Der Experte benötigt:

-   Einen PC, auf dem [!include[pn-ms-windows-short](../includes/pn-ms-windows-short.md)] 10 mit der neuesten Version von [Microsoft Teams](https://products.office.com/microsoft-teams/group-chat-software) läuft oder ein mobiles Gerät, auf dem [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] Mobile ausgeführt wird. Der Experte verwendet [!include[pn-teams](../includes/pn-teams.md)], um mit dem [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Benutzer von [!include[pn-HoloLens](../includes/pn-HoloLens.md)] zu kommunizieren. [!include[pn-teams](../includes/pn-teams.md)] kann eventuell [kostenlos heruntergeladen werden](https://teams.microsoft.com/downloads).

-   Ein kostenloses [!include[cc-microsoft](../includes/cc-microsoft.md)]-Konto. Der Experte hat mitunter bereits ein [!include[cc-microsoft](../includes/cc-microsoft.md)]-Konto, wenn er sich im [!include[cc-microsoft](../includes/cc-microsoft.md)] App Store, bei Skype, Xbox, Hotmail oder Outlook.com registriert hat. Verfügt der Experte noch nicht über ein [!include[cc-microsoft](../includes/cc-microsoft.md)]-Konto, kann er sich unter [https://account.microsoft.com/account](https://account.microsoft.com/account) für eines registrieren.
...
3.  Setzen Sie **[!include[cc-microsoft](../includes/cc-microsoft.md)] [!include[pn-teams](../includes/pn-teams.md)] für alle Benutzer dieses Typs an- oder ausschalten** auf **An** und wählen Sie anschließend **Speichern**.
    ...
    ![Speichern](media/9f095e7553a4af03ff13ea6a29a9343a.png "Speichern")
