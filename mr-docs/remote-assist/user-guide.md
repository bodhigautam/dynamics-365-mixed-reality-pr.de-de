...
Benötigen Sie weitere Hilfe? [Unter „Häufig gestellte Fragen zu Remote Assist“](faq.md) finden Sie Antworten auf typische Fragen.

[Sehen Sie sich die Anleitungsvideos](videos.md) zu [!include[pn-remote-assist](../includes/pn-remote-assist.md)] an.

## <a name="what-youll-need"></a>Was Sie benötigen

-   Ein Abonnement von [!include[pn-remote-assist](../includes/pn-remote-assist.md)]. [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] ist im [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Abonnement für Einzelpersonen, die eine [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Lizenz in [!include[pn-HoloLens](../includes/pn-HoloLens.md)] verwenden, enthalten. Für Einzelpersonen (Experten), die mit einem [!include[pn-remote-assist](../includes/pn-remote-assist.md)]-Benutzer von [!include[pn-HoloLens](../includes/pn-HoloLens.md)] kommunizieren, ist außerdem eine [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)]-Lizenz erforderlich. [!include[pn-teams](../includes/pn-teams.md)] steht diesen Benutzern eventuell [als kostenloser Download](https://teams.microsoft.com/downloads) zur Verfügung. Wenn Sie als Administrator für Ihre Organisation tätig sind, [informieren Sie sich, wie Sie Remote Assist ausprobieren, kaufen und nutzen können](../licensing/buy-and-deploy.md). 

    > [!TIP] 
    > Sie können [!include[pn-dyn-365-remote-assist](../includes/pn-dyn-365-remote-assist.md)] bis zu 90 Tage lang kostenlos ausprobieren. [Erfahren Sie mehr über die kostenlose 90-Tage-Testversion von Dynamics 365 Remote Assist](try-remote-assist-free.md).

-   Ein [HoloLens auf dem das Windows 10 April 2018 Update](https://support.microsoft.com/en-us/help/12643) ausgeführt wird.

-   Um einen Videoanruf tätigen zu können, muss der Kontakt die neueste Version von [Microsoft Teams](https://products.office.com/en-us/microsoft-teams/group-chat-software) auf einem PC mit [!include[pn-ms-windows-short](../includes/pn-ms-windows-short.md)] 10 oder einem mobilen Gerät mit der [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] Mobile-App verwenden. [Erfahren Sie mehr über die Verwendung von Teams mit Remote Assist.](use-microsoft-teams-with-remote-assist.md)
...
Wie Sie [!include[pn-remote-assist](../includes/pn-remote-assist.md)] installieren, hängt davon ab, wie Ihr Administrator die App zur Verfügung stellt. So kann Ihr Administrator Sie [die App aus dem Microsoft Store für Verbraucher](https://www.microsoft.com/store/apps/9P77QGW10K9M), aus dem privaten Store Ihrer Organisation, über einen E-Mail-Link oder eine andere Methode installieren lassen.

### <a name="install-the-application-through-the-microsoft-store-for-consumers"></a>Installieren der Anwendung über den Microsoft Store für Verbraucher
...
Sie können einen Einzelanruf mit einem Teams-Benutzer eines anderen Unternehmens tätigen oder empfangen, wenn in [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] der externe Zugang für beide Unternehmen aktiviert wurde. Wenn Sie der Administrator für Ihre Organisation sind, lesen Sie [Einrichtung firmenübergreifender Anrufe](cross-company-calling.md), um einen externen Zugang einzurichten.
...
> [!NOTE] 
> Wenn Sie den gewünschten Kontakt nicht finden, kann es möglicherweise daran liegen, dass der externe Zugang in [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] für Ihr oder das andere Unternehmen nicht aktiviert wurde. Wenden Sie sich an Ihren Administrator, um Hilfe zu erhalten. 
...
> [!NOTE]
> Wenn Sie einen Teilnehmer stummschalten, können Sie die Stummschaltung nicht wieder aufheben. Die Teilnehmer müssen die Stummschaltung selbst in [!include[pn-teams](../includes/pn-teams.md)] aufheben. 


## <a name="record-a-call"></a>Einen Anruf aufzeichnen

Sie können einen Anruf in einer Datei aufzeichnen, um diesen später zu überprüfen. Dies ist eine gute Möglichkeit, Anrufe zu Schulungs- oder Aufzeichnungszwecken aufzuzeichnen.

Es gibt zwei Möglichkeiten, Anrufe aufzeichnen:

- Mit der in PCs mit [!include[pn-ms-windows-short](../includes/pn-ms-windows-short.md)] 10 vorhandenen Spielleiste.

- Mit der Aufzeichnungsfunktion von [!include[pn-teams](../includes/pn-teams.md)].

### <a name="record-a-call-using-the-game-bar-in-windows-10-pcs"></a>Anrufe mit der in PCs mit Windows 10 enthaltenen Spielleiste aufzeichnen

1. Bei PCs mit [!include[pn-ms-windows-short](../includes/pn-ms-windows-short.md)] 10 können Sie in [!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] zu Anrufen hinzustoßen.

2. Um die Spielleiste zu öffnen, drücken Sie die **Windows-Logo-Taste ![Windows-Logo-Taste)](media/windows-logo-key.png "Windows-Logo-Taste") + G**.
...
4. Zum Beenden der Aufzeichnung, wählen Sie die Schaltfläche **Aufzeichnung beenden** aus.
   ...
   Das Video zur Aufzeichnung wird im Ordner **Video/Aufzeichnungen** angezeigt.
...
[!include[pn-microsoft-teams](../includes/pn-microsoft-teams.md)] unterstützt [cloudbasierte Anrufaufzeichnungen von Gruppenanrufen](https://support.office.com/en-us/article/record-a-meeting-in-teams-34dfbe7f-b07d-4a27-b4c6-de62f1348c24). Aufzeichnung werden in Microsoft Stream gespeichert und geteilt.
...
3.  Zum Beenden der Aufzeichnung, wählen Sie **Weitere Optionen** (...) > **Aufzeichnung beenden**.
    ...
    Die Aufzeichnung wird bearbeitet (und kann einige Zeit in Anspruch nehmen) und in Microsoft Stream gespeichert. Derjenige, der die Aufzeichnung gestartet hat, erhält eine E-Mail von [!include[pn-microsoft-stream](../includes/pn-microsoft-stream.md)], sobald die Aufzeichnung zur Verfügung steht. Dies erscheint ebenfalls im Gruppenchat.
