...
2. Führen Sie einen der folgenden Schritte aus:
   ...
   - Wenn die richtige Version von [!include[pn-field-service](../includes/pn-field-service.md)] installiert ist und die Ansicht Meine in Bearbeitung befindlichen Buchungen enthalten ist, fahren Sie mit [Einen Arbeitsauftrag und eine Buchung hinzufügen](#add-a-work-order-and-booking) fort, der nächsten Prozedur in diesem Thema.
